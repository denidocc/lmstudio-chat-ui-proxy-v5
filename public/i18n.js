(function () {
  ...
  const I18N = {
    ru: {
      ...
      imageModeHeaderSubtitle: "Генерация изображений · ComfyUI · {comfyUrl}",
      ...
      panelSearx: "SearXNG",
      panelSearxHint: "поиск в интернете",
      searxHint: "Локальный meta-search для web research. Запустите start-searxng.bat (Docker), затем Test.",
      searxUrl: "Адрес SearXNG",
      testSearx: "Проверить SearXNG",
      saveSearx: "Сохранить URL",
      checkingSearx: "Проверка SearXNG...",
      searxAvailable: "SearXNG доступен · результатов: {count}",
      searxUnavailable: "SearXNG недоступен: {message}",
      searxSettingsSaved: "URL SearXNG сохранён.",
      searxNoResults: "SearXNG ответил, но результатов нет.",
      searxJsonForbidden: "JSON API отключён. Добавьте json в search.formats в settings.yml и перезапустите контейнер.",
      panelFirecrawl: "Firecrawl",
      panelFirecrawlHint: "scrape → markdown",
      firecrawlHint: "Извлечение текста страницы в markdown. Запустите start-firecrawl.bat (Docker), затем Test.",
      firecrawlUrl: "Адрес Firecrawl",
      firecrawlTestUrl: "URL для теста",
      testFirecrawl: "Проверить Firecrawl",
      saveFirecrawl: "Сохранить URL",
      checkingFirecrawl: "Scrape через Firecrawl...",
      firecrawlAvailable: "Firecrawl OK · {length} симв. из {url}",
      firecrawlUnavailable: "Firecrawl недоступен: {message}",
      firecrawlSettingsSaved: "Настройки Firecrawl сохранены.",
      firecrawlNoMarkdown: "Scrape прошёл, но markdown пустой.",
    },
    en: {
      pageTitle: "LM Studio LAN Chat",
      ...
      modeChat: "Chat",
      modeImage: "Image",
      imageModeHeaderSubtitle: "Image generation · ComfyUI · {comfyUrl}",
      ...
      panelSearx: "SearXNG",
      panelSearxHint: "web search API",
      searxHint: "Local meta-search for web research. Start with start-searxng.bat (Docker), then Test.",
      searxUrl: "SearXNG URL",
      testSearx: "Test SearXNG",
      saveSearx: "Save URL",
      checkingSearx: "Checking SearXNG...",
      searxAvailable: "SearXNG available · {count} result(s)",
      searxUnavailable: "SearXNG unavailable: {message}",
      searxSettingsSaved: "SearXNG URL saved.",
      searxNoResults: "SearXNG responded but returned no results.",
      searxJsonForbidden: "JSON API is disabled. Add json to search.formats in settings.yml and restart the container.",
      panelFirecrawl: "Firecrawl",
      panelFirecrawlHint: "scrape URL to markdown",
      firecrawlHint: "Scrape a page to markdown. Start with start-firecrawl.bat (Docker), then Test.",
      firecrawlUrl: "Firecrawl URL",
      firecrawlTestUrl: "Test scrape URL",
      testFirecrawl: "Test Firecrawl",
      saveFirecrawl: "Save URL",
      checkingFirecrawl: "Scraping via Firecrawl...",
      firecrawlAvailable: "Firecrawl OK · {length} chars from {url}",
      firecrawlUnavailable: "Firecrawl unavailable: {message}",
      firecrawlSettingsSaved: "Firecrawl settings saved.",
      firecrawlNoMarkdown: "Scrape completed but markdown is empty.",
    },
  };
